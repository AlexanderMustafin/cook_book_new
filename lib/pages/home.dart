    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ListTile(
            leading:
                Image.asset("assets/img/salad.jpg", width: 70, height: 100),
            title: Text('Salads'),
          ...
          ListTile(
            leading:
                Image.asset("assets/img/snacks.jpg", width: 70, height: 100),
            title: Text('Snacks, sandwiches'),
            subtitle: Text('Кол-во предложений'),
            onTap: () {},
          ),
          ListTile(
            leading: Image.asset("assets/img/soup.jpg", width: 70, height: 100),
          ...
          ListTile(
            leading:
                Image.asset("assets/img/fish_meal.jpg", width: 70, height: 100),
